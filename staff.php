        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-primary" href="edit_staff.php?staff_id=<?php echo $staff['staff_id'];?>">Edit</a></td>
              <td><a class="btn btn-danger"  href="delete_staff.php?staff_id=<?php echo $staff['staff_id'];?>">Delete</a></td>
