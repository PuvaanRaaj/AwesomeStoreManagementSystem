...
if(isset($_POST['update_images'])){
        ...
        if($stmt->execute()){
            ?>
        <script>
        window.location.href="products.php?images_updated=Images have been updated successfully"
      </script>
        <?php
             ...
             ?>
        <script>
        window.location.href="products.php?images_failed=Error occured, try again"
      </script>
        <?php
